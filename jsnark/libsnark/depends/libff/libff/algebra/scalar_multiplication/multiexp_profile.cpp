    ...
    bool compare_answers)
{
    for (size_t expn = expn_start; expn <= expn_end_fast; expn++) {
        ...
        test_instances_t<GroupT> group_elements =
            generate_group_elements<GroupT>(1, 1 << expn);
        test_instances_t<FieldT> scalars =
            generate_scalars<FieldT>(1, 1 << expn);
...
int main(void)
{
    ...
    printf("Profiling BLS12_381_G1\n");
    bls12_381_pp::init_public_params();
    print_performance_csv<G1<bls12_381_pp>, Fr<bls12_381_pp> >(2, 20, 14, true);

    printf("Profiling BLS12_381_G2\n");
    // print_performance_csv<G2<bls12_381_pp>, Fr<bls12_381_pp> >(2, 20, 14, true);
