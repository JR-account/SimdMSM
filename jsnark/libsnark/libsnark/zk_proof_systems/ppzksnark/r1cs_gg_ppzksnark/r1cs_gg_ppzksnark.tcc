                                                      ...
                                                      const r1cs_gg_ppzksnark_auxiliary_input<ppT> &auxiliary_input)
{
    ...
    libff::G1<ppT> evaluation_At = libff::multi_exp_with_mixed_addition_rmdupli<libff::G1<ppT>,
                                                                        libff::Fr<ppT>,
                                                                        libff::multi_exp_method_pip_avx_threads>(
        pk.A_query.begin(),
    ...
    knowledge_commitment<libff::G2<ppT>, libff::G1<ppT> > evaluation_Bt = kc_multi_exp_with_mixed_addition<libff::G2<ppT>,
                                                                                                           libff::G1<ppT>,
                                                                                                           libff::Fr<ppT>,
                                                                                                           libff::multi_exp_method_pair_avx_threads>(
        pk.B_query,
        0,
